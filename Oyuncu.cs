...
namespace HTML_Veri_Çekme
{
    class Oyuncu
    {
        ...
        static Dictionary<string, string> KullanıcılarSözlük = Form1.KullanıcılarSözlük;
        public static void OyuncuSil(int indis)
        {
            OyuncuTablosu.SelectNodes("tbody/tr[@id='OT_Satır']")[indis].RemoveAll();
        }
        public static void OyuncularıGüncelle()
        {
            ...
            Form1.Kaynak.DataSource = Oyuncu.Liste;
        }
        public string Rütbe
        {
        ...
        public string KullanıcıAdı
        {
            ...
            set
            {
                ...
                Console.WriteLine(OyuncuSatır.SelectSingleNode("td[@id='OT_Kullanıcı']/a/span").InnerText);
            }
        }
